...
3. Create DVC key. Terraform (at least as configured in these instructions) is unable to create service account credentials. Thus, you must manually create the DVC service account key.
