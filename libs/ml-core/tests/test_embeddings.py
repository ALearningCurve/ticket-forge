...
class TestEmbeddingService:
    ...
    def test_embed_text_with_empty_string_raises_error(self, embedding_service):
    ...
    def test_embed_batch_returns_correct_shape(self, embedding_service):
    ...
    def test_embed_batch_with_empty_list_raises_error(self, embedding_service):
